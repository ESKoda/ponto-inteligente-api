...
VALUES (NULL, '28062406000118', CURRENT_DATE(), CURRENT_DATE(), 'Kazale IT');
...
VALUES (NULL, '93005585018', CURRENT_DATE(), CURRENT_DATE(), 'admin@kazale.com', 'ADMIN', 'ROLE_ADMIN', NULL, NULL, 
'$2a$06$xIvBeNRfS65L1N17I7JzgefzxEuLAL0Xk0wFAgIkoNqu9WD6rmp4m', NULL, 
(SELECT `id` FROM `empresa` WHERE `cnpj` = '28062406000118'));
