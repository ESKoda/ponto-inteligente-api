...
public class CadastroPFController {
	...
	private CadastroPFDto converterCadastroPFDto(Funcionario funcionario) {
		...
		//setQtdHorasAlmoco,setQtdHorasTrabalhoDia,setValorHora : aceitam null, por isso colocamos como @Trasient
	...
	private Funcionario converterDtoParaFuncionario(CadastroPFDto cadastroPFDto, BindingResult result) 
		...
		//ifPresent, se existir o qtdHorasAlmoco no cadastroPFDto entao seta o valor
	...
	private void validarDadosExistentes(CadastroPFDto cadastroPFDto, BindingResult result) {
		Optional<Empresa> empresa = this.empresaService.buscarPorCnpj(cadastroPFDto.getCnpj());
		if (!empresa.isPresent()) {//se a empresa nao existir
