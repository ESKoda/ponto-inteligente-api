...
public class Lancamento implements Serializable{
	...
	return "Lancamento [id=" + id + ", data=" +
			data + ", descricao =" + descricao + ",	localizacao=" + localizacao + ", dataCricao=" + dataCriacao + ", dataAtualiacao="+ dataAtualizacao + ", tipo="+ tipo + ", funcionario=" + funcionario + "]" ;
	}
